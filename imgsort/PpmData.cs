...
namespace ProgramingContestImageSort
{
    public class PpmData
    {
        ...
        public static int picPieceX { get; private set; }
        public static int picPieceY { get; private set; }
        ...
        public void ppmRead(string ppmFile)
        {
            ...
            PpmData.picPieceX = int.Parse((str[1].Trim(' ', '#').Split(space))[0]);
            PpmData.picPieceY = int.Parse((str[1].Trim(' ', '#').Split(space))[1]);
